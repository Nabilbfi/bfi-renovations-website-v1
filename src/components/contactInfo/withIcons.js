        ...
        <List className="spacing">
          ...
          <li>
            <Flex>
              ...
              {/* "mailto: bfirenovations.ca" */}
          <li>
            <Flex>
              <SiMailDotRu className="accent" />
              <a className=" italics" href={`mailto:${Info.mail1}`}>
                {Info.mail1}
              </a>
            </Flex>
          </li>
          <li>
            <Flex>
              <SiMailDotRu className="accent" />
              <a className=" italics" href={`mailto:${Info.mail2}`}>
                {Info.mail2}
              </a>
            </Flex>
          </li>
          <li>
            <Flex>
              <SiMailDotRu className="accent" />
              <a className=" italics" href={`mailto:${Info.mail3}`}>
                {Info.mail3}
              </a>
            </Flex>
          </li>
