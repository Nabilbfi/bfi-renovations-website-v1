...
import Footer from "../components/footers/footerBasic"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <a
                          href="http://www.bfirenovations.ca"
                          target="_blank"
                          data-custom-class="link"
                        >
                          http://www.bfirenovations.ca
                        </a>
                      </bdt>{" "}
                    ...
                    <bdt data-type="body">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <a
                              href="http://www.bfirenovations.ca/privacy-policy"
                              target="_blank"
                              data-custom-class="link"
                            >
                              http://www.bfirenovations.ca/privacy-policy
                            </a>
                          </bdt>
                        </b>
                        <span
              ...
              <div align="center" style={{ textAlign: "left", lineHeight: 1 }}>
                ...
                <div align="center" style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    . <bdt className="question">BFI Renovations</bdt> and
              ...
              <div align="center" style={{ textAlign: "left" }}>
                ...
                >
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="question">Torcastle Way</bdt>
                        <bdt className="statement-end-if-in-editor" />
                        <bdt className="block-component" />
                      </span>
                    </strong>
                ...
                >
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="question">Kanata</bdt>
                        <bdt className="block-component" />,{" "}
                        <bdt className="question">Ontario</bdt>
                        <bdt className="block-component" />
                      </span>
                    </strong>
                    <strong>
                  ...
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="question">K2Y 1Y6</bdt>
                        <bdt className="statement-end-if-in-editor" />{" "}
                        <bdt className="block-component" />
                        <bdt className="block-component" />
                      </span>
                ...
                >
                  ...
                  >
                    <bdt
                      ...
                      data-type="question"
                    >
                      <strong>bfirenovations@gmail.com</strong>
                    </bdt>
                  </span>
                </div>
                <br />
